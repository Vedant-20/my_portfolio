...
const SocialLinks = () => {
  return (
    <div className="flex text-lg content-center space-x-6 sm:justify-start justify-center ">
      ...
      <div onClick={()=>window.open('https://www.linkedin.com/in/vedant-warjurkar','_blank')} className='mybg w-12 h-12 rounded-full flex justify-center items-center cursor-pointer'>
